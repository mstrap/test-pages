...
differently from SVN:
  ...
  - **Git** In Git, you just rename or move your files/directories, and
    ...
    Tree](https://www.syntevo.com/doc/display/SG170/Local+Operations+on+the+Working+Tree#LocalOperationsontheWorkingTree-LocalOperationsontheWorkingTree-moving-files)
