...
explained in [Merge](Branch-related_1704322.html#Branch-related-merge)
and [Rebase](Branch-related_1704322.html#Branch-related-rebase),
...
[Merge](Branch-related_1704322.html#Branch-related-merge) and
[Rebase](Branch-related_1704322.html#Branch-related-rebase) for details.
...
[Branches](Branches_1704314.html#Branches-branches)). The preferences
...
SmartGit's main window:
  ...
  - **Menu and toolbar** In the menu, you can invoke the various Pull
    commands with **Remote|Push**, **Remote|Push To** and **Remote|Push
    Commits**. The first two may also be available as toolbar buttons,
    depending on your toolbar configuration. The third command is only
    enabled if the **Journal** view is focused.
